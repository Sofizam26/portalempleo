...
class Usuario implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function setPassword(string $password){ $this->password = $password; return $this; }
    public function getRol() { return $this->rol; }
    public function setRol(string $rol){ $this->rol = $rol; return $this; }
    public function getFechaRegistro() { return $this->fecha_registro; }
    public function setFechaRegistro(\DateTimeInterface $fecha_registro) { $this->fecha_registro = $fecha_registro; return $this; }
    public function getCandidato() { return $this->candidato; }
    public function setCandidato(Candidato $candidato) { $this->candidato = $candidato; return $this; }
    public function getAnunciante() { return $this->anunciante; }
    public function setAnunciante(Anunciante $anunciante) { $this->anunciante = $anunciante; return $this; }
