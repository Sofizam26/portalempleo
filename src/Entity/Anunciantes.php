...
class Anunciante
{
    ...
    public function getNombreAnunciante() { return $this->nombre_anunciante; }
    public function setNombreAnunciante(string $nombre_anunciante) { $this->nombre_anunciante = $nombre_anunciante; return $this; }
    public function getTipo() { return $this->tipo; }
    public function setTipo(string $tipo) { $this->tipo = $tipo; return $this; }
    public function getDescripcion() { return $this->descripcion; }
    public function setDescripcion(string $descripcion) { $this->descripcion = $descripcion; return $this; }
    public function getSitioWeb() { return $this->sitio_web; }
    public function setSitioWeb(string $sitio_web) { $this->sitio_web = $sitio_web; return $this; }
    public function getCiudad() { return $this->ciudad; }
    public function setCiudad(string $ciudad) { $this->ciudad = $ciudad; return $this; }
    public function getOfertas() { return $this->ofertas; }
